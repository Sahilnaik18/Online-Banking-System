    ...
    <footer className="bg-blue-50 dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl px-4">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold  uppercase dark:text-white text-customBlue">Company</h2>
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold  uppercase dark:text-white text-blue-900">Help Center</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold  uppercase dark:text-white text-blue-900">Legal</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white text-customBlue">Download</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
        ...
        <div className="px-4 py-6 bg-blue-50 dark:bg-gray-700 flex flex-col md:flex-row md:justify-between items-center">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center ">
            © 2024 <a href="https://flowbite.com/" className="hover:underline">PSS™</a>. All Rights Reserved.
          </span>
